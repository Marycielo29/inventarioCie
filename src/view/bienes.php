...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            ...
            <a href="<?= BASE_URL?>reporte-bienes" class="btn btn-outline-success"><i class="fa fa-file-excel"></i></a>
            <a href="<?= BASE_URL?>imprimir-bienes" class="btn btn-outline-danger"><i class="fa fa-print"></i></a>
